...
App.launchScreens({
  ...
  android_xxxhdpi_portrait: '/public/img/mobile/android/splashscreen/drawable-xxxhdpi/screen.png',
  android_xxxhdpi_landscape: '/public/img/mobile/android/splashscreen/drawable-land-xxxhdpi/screen.png',
});
