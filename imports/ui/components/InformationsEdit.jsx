  ...
  render() {
    ...
    return (
      <div className="sub-container page">
        <Breadcrumb title="Mes informations personnelles" hasBack />
        <form id="box" onSubmit={this.updateInfo}>
          <div className="header">
            <i className="big-center-icon icon icon-info" />
            <h4>Modifier mes infos</h4>
          </div>
          <div className="content">
            <fieldset className="large">
              <label><i className="icon icon-user" />Nom d'utilisateur</label>
              <input
                className="large"
                type="text"
                ref="username"
            ...
            <fieldset className="large">
              <label><i className="icon icon-user" />Prénom</label>
              <input
                className="large"
                type="text"
                ref="firstname"
            ...
            <fieldset className="large">
              <label><i className="icon icon-user" />Nom</label>
              <input
                className="large"
                type="text"
                ref="lastname"
            ...
            <fieldset className="large">
              <label><i className="icon icon-user" />Email</label>
              <input
                className="large"
                type="text"
                ref="email"
            ...
            <fieldset className="large merge">
              <label><i className="icon icon-lock" />Mot de passe</label>
              <input
                className="large"
                type="password"
                ref="oldPassword"
