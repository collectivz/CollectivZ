      ...
      ? <div className="chat-special-bubble chat-special-bubble-mission">
          <div className="bubble-content">
            <div className="bubble-header">
              ...
              <span>
                <a href="">{this.getAuthorName(channel.author)}</a>
                {" "}à ouvert une action
              </span>
              <h5>{channel.name}</h5>
            ...
            <div className="bubble-content-text">
              {channel.description
                ...
                : ""}
              <button className="button only-icon" onClick={this.joinChannel}>
                <span>Rejoindre</span><i className="icon icon-chevron-right" />
              </button>
