    ...
    return (
      <div className="chat-filter">
        ...
        <TouchEvent
          ...
          class={classNames("filter-item touch-event", {
        ...
        {channel.connections.channelCount
          ? <TouchEvent
              ...
              class={classNames(
                "filter-item touch-event",
                { active: this.state.activeFilter == "channel" },
                { more: channel.connections.channelCount >= 10 }
              )}
            >
        ...
        {channel.connections.beerCount
          ? <TouchEvent
              ...
              class={classNames(
                "filter-item touch-event",
                { active: this.state.activeFilter == "beer" },
                { more: channel.connections.beerCount >= 10 }
              )}
            >
        ...
        {channel.connections.coinCount
          ? <TouchEvent
              ...
              class={classNames(
                "filter-item touch-event",
                { active: this.state.activeFilter == "coin" },
                { more: channel.connections.coinCount >= 10 }
              )}
            >
        ...
        {channel.connections.feedbackCount
          ? <TouchEvent
              onClick={() => {
                this.onClick("feedback");
              }}
              class={classNames(
                "filter-item touch-event",
                { active: this.state.activeFilter == "feedback" },
                { more: channel.connections.feedbackCount >= 10 }
              )}
            >
        ...
        {channel.connections.pollCount
          ? <TouchEvent
              ...
              class={classNames(
                "filter-item touch-event",
                { active: this.state.activeFilter == "poll" },
                { more: channel.connections.pollCount >= 10 }
              )}
            >
              <i className="icon icon-pie-chart pollz-color" />
              <span className="pollz-color">
                {channel.connections.pollCount}
              </span>
            </TouchEvent>
          : ""}
