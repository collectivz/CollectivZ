                    ...
                    <div className="sub-container">
                      ...
                      <div className="list">
                        ...
                        <TouchEvent class="list-item small touch-event" onClick={this.goTo.bind(this, '/my-profile/infos')}>
                          <div className="circle"><i className="icon icon-info info-color" /></div>
                      ...
                      */}
                        ...
                        <TouchEvent class="list-item small touch-event" onClick={this.goTo.bind(this, '/my-profile/hero')}>
                          <div className="circle"><i className="icon icon-hero hero-color" /></div>
                          <div className="list-item-content">
                        ...
                        <TouchEvent class="list-item small touch-event" onClick={this.goTo.bind(this, '/my-profile/skills')}>
                          <div className="circle"><i className="icon icon-tools tools-color" /></div>
                          <div className="list-item-content">
                        ...
                        <TouchEvent class="list-item small touch-event" onClick={this.goTo.bind(this, '/my-profile/actions')}>
                          <div className="circle"><i className="icon icon-action action-color" /></div>
                          <div className="list-item-content">
                        ...
                        <TouchEvent class="list-item small touch-event" onClick={this.goTo.bind(this, '/my-profile/groups')}>
                          <div className="circle"><i className="icon icon-users group-color" /></div>
                          <div className="list-item-content">
                        ...
                        <TouchEvent class="list-item small touch-event" onClick={this.goTo.bind(this, '/my-profile/history')}>
                          <div className="circle"><i className="icon icon-badge badge-color" /></div>
                          <div className="list-item-content">
