...
\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00';
	                                        ...
	                                        const color = String.fromCharCode(color_table[nbr].r) + String.fromCharCode(color_table[nbr].g) + String.fromCharCode(color_table[nbr].b);
	                                        ...
	                                        for (let i = 0; i < 6400; i += 1) {
		                                        if (seed[x_index][y_cmp] == 0)			                                        { str += color; }		                                        else			{ str += '\xff\xff\xff'; }
...
export function generateAvatar(username) {
  ...
  fs.writeFileSync(`${process.env.HOMEPATH}/CollectivZ/chatz-dev/public/img/${username}.bmp`, image);
